...
| [plans/2026-09-26-simplification-sweep.md](plans/2026-09-26-simplification-sweep.md) | in progress: 0/7 - s3, s4, r2, r3, p5, a1, then v1 | the session list, promoted to a dated checklist so it survives the session |
