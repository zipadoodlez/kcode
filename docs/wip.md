...
| [plans/2026-09-26-simplification-sweep.md](plans/2026-09-26-simplification-sweep.md) | in progress: 0/7, next is **s3** (then s4, r2, r3, p5, a1, v1 last). Branch `palette/roles-collapse`, not `main` | start at the Handoff section in that doc: what is verified, what is committed-but-unbuilt, the exact commands and failure baseline |
