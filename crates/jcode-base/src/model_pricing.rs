...
//! providers, including every OpenAI-compatible profile kcode ships.
//!
//! This module mirrors the OpenRouter catalog pattern:
//!   - a 24h disk cache under `~/.kcode/cache/models_dev_pricing.json`,
...
/// Translate a kcode provider key (runtime key, activity source key, or
...
/// Look up live pricing for `model` under a kcode provider key. Returns `None`
