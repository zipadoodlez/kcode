...
pub(super) async fn stream_response(
    ...
    if !response.status().is_success() {
        ...
        // For rate limits, include retry info in the error and turn structured
        // provider payloads into a message that is useful outside the logs.
...
fn format_rate_limit_error(body: &str, retry_after: Option<Duration>) -> String {
