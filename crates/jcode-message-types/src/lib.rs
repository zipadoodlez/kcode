...
// ---------------------------------------------------------------------------
// Batched tool-call progress
//
// These types were a one-file crate (`jcode-batch-types`) consumed by the
// protocol and bus layers; folded here because they are message shapes that
// reference `ToolCall` directly.
// ---------------------------------------------------------------------------
